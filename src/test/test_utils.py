...
class UtilTest(unittest.TestCase):
    ...
    def test_hash_160_to_address(self):
        ...
        self.assertEqual(hash_160_to_address('1ad3b0b711f211655a01142fbb8fecabe8e30b93'.decode('hex')),
                         'FXcZcPym3zhSQ3k9wH7f5cW6smFMWx8UdL')
    ...
    def test_bc_address_to_hash_160(self):
        ...
        self.assertEqual(bc_address_to_hash_160('FXcZcPym3zhSQ3k9wH7f5cW6smFMWx8UdL1337'), None)
        self.assertEqual(bc_address_to_hash_160('FXcZcPym3zhSQ3k9wH7f5cW6smFMWx8UdL').encode('hex'),
